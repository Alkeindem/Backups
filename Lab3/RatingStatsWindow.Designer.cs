namespace Chatbot
{
    partial class RatingStatsWindow
    {
        /// <summary>
        ...
        /// </summary>
        private void InitializeComponent(double average, int min, int max, int count)
        {
            ...
            this.label1.Text = "Numero de evaluaciones:";
            ...
            this.label3.Text = "Calificacion minima";
            ...
            this.label4.Text = "Calificacion maxima";
            ...
            this.label6.Text = average.ToString().Substring(0, 4);
            // 
            // label7
            // 
            ...
            this.Name = "RatingStatsWindow";
            this.Text = "Rating Stats";
            this.Load += new System.EventHandler(this.RatingStatsWindow_Load);
